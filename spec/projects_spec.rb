...
describe 'Test Project Handling' do
  ...
  it 'HAPPY: should be able to get list of all projects' do
    Credence::Project.create(DATA[:projects][0]).save_changes
    Credence::Project.create(DATA[:projects][1]).save_changes
  ...
  it 'HAPPY: should be able to get details of a single project' do
    ...
    Credence::Project.create(existing_proj).save_changes
